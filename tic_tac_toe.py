...
## Tic-Tac-Toe game from Chapter 10
...
##################################################################
    ...
    # "board" is list of 10 strings representing the game board
...
##################################################################
    ...
    # Returns a list of the player's letter as the
...
def isWinner(bo, le):
##################################################################
    # Given a board and a player's letter, this function
...
##################################################################
    ...
    # First, check if we an win in the next move:
    for i in range(1, 10):
    ...
    # Check if the player could win on their next move and
    # block them.
    for i in range(1, 10):
        boardCopy = getBoardCopy(board)
        if isSpaceFree(boardCopy, i):
    ...
    # Try to take te center, if it's free
    if isSpaceFree(board, 5):
        return 5

    # Move on on the of the sides
